...
from HugoMusic.config import BOT_NAME, BOT_USERNAME, OWNER_NAME, SUPPORT_GROUP, UPDATES_CHANNEL, ASSISTANT_NAME
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "🧪 Source Code 🧪", url="https://github.com/StevanKz/HugoMusic"
                    )
                ]
            ]
        ),
