...
from HugoMusic.config import BOT_USERNAME, BOT_NAME, ASSISTANT_NAME, OWNER_NAME, UPDATES_CHANNEL, SUPPORT_GROUP
from HugoMusic.helpers.filters import command
from pyrogram import Client, filters
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton, Chat, CallbackQuery
from HugoMusic.helpers.decorators import sudo_users_only
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "🧪 Source Code 🧪", url="https://github.com/QueenArzoo/HugoMusic"
                    )
                ]
            ]
        ),
