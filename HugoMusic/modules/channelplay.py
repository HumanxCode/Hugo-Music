...
from HugoMusic.modules.play import generate_cover
from HugoMusic.modules.play import arq
from HugoMusic.modules.play import cb_admin_check
from HugoMusic.modules.play import transcode
from HugoMusic.modules.play import convert_seconds
from HugoMusic.modules.play import time_to_seconds
from HugoMusic.modules.play import changeImageSize
from HugoMusic.config import BOT_NAME as bn
from HugoMusic.config import DURATION_LIMIT
from HugoMusic.config import UPDATES_CHANNEL as updateschannel
from HugoMusic.config import que
from HugoMusic.function.admins import admins as a
from HugoMusic.helpers.errors import DurationLimitError
from HugoMusic.helpers.decorators import errors
from HugoMusic.helpers.admins import get_administrators
from HugoMusic.helpers.channelmusic import get_chat_id
from HugoMusic.helpers.decorators import authorized_users_only
from HugoMusic.helpers.filters import command
from HugoMusic.helpers.filters import other_filters
from HugoMusic.helpers.gets import get_file_name
from HugoMusic.services.callsmusic import callsmusic
from HugoMusic.services.callsmusic import client as USER
from HugoMusic.services.converter.converter import convert
from HugoMusic.services.downloaders import youtube
from HugoMusic.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @HugoMusic to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)
